...
class VerfahrensparameterZweiSchrittVerfahrenV7 extends BaseDeg implements VerfahrensparameterZweiSchrittVerfahren
{
    ...
    /** @var integer|null Allowed values: 1 = numerisch, 2 = alfanumerisch */
